    ...
    try {
      ...
      if (_shouldShowNotification()) {
        await NotificationService.showGeofenceNotification(
          ...
          body: 'You have entered the ${geofence.type.toString().split('.').last} geofence',
          isEntering: true,
        );

        await NotificationService.showAttendanceNotification(
          title: 'Attendance Recorded',
          body: 'Entry recorded at ${geofence.name}',
        );
    ...
    try {
      ...
      if (_shouldShowNotification()) {
        await NotificationService.showGeofenceNotification(
          ...
          body: 'You have left the ${geofence.type.toString().split('.').last} geofence',
          isEntering: false,
        );

        await NotificationService.showAttendanceNotification(
          title: 'Attendance Recorded',
          body: 'Exit recorded from ${geofence.name}',
        );
